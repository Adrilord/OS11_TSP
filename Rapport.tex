...
Soient les données de \texttt{DegradLevel\_2.csv}, nous traçons leurs processus de dégrader. (Les annexes \eqref{annexe:import_degrad} et \eqref{annexe:premier_plot_degrad})
